...
$files = 1..3 | ForEach-Object { Join-Path $root "docs/v0.4/Builds_ASCENDANCY_REVIEW_$_.md" }
$nameToEnum = [ordered]@{
...
$output = Join-Path $root 'src/Game.Core/Builds/Data/builds-ascendancies.json'
