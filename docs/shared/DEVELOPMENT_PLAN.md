...
> 当前开发入口：[v0.5 六阶段计划](../v0.5/V0_5_DEVELOPMENT_PLAN.md)。2026-09-07 已确认沉金港为唯一新增大型玩法，并纳入现有全部动画审核与优化；无光矿脉延期，具体版本待定。第一阶段 21 项方案已统一确认，第一阶段规格、静态审计与代表场景性能前测已交付；前测发现的问题交由第四/第五阶段修复验收，完整规则见[确认记录](../v0.5/Harbor_REWARD_DECISIONS.md)。下文保留历史阶段计划，旧版本归属不覆盖最新决策。
