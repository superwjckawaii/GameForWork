...
The generated service preview encoded its transparency checker as light pixels. `scripts/prepare_p27_monster_master.ps1` removes only neutral near-white background pixels and writes the production RGBA source used by the atlas builder.
