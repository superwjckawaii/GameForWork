...
public sealed class EquipmentImportFeatureTests
{
    [Fact]
    ...
    public void RequirementsAndImportedStatsReachCharacterCalculation()
    {
        ...
        var item = new ItemInstance("formal-calc", ItemBases.Get("core.base.iron_ring"), 100, ItemRarity.Rare,
    ...
    {
        ItemBaseDefinition ring = ItemBases.Get("core.base.iron_ring");
        AffixDefinition top = Affixes.For(ring, 120)
    ...
    public void AffixBrowserUsesTheFormalCatalogWithoutTruncation()
    {
        ...
        ItemBaseDefinition sword = ItemBases.Get("equipmentImport.base.ezomyte_blade");
