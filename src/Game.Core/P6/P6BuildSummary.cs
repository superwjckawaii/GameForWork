...
public static class P6BuildSummaryRules
{
    ...
    private static P6DefenseBreakdown CalculateDefense(P1TeamBuild build)
    {
        ...
        return new P6DefenseBreakdown(
            ...
            P30CombatRules.EffectiveResistance(sheet.FireResistanceBasisPoints, sheet.ResistanceMaximum(EnemyDamageType.Fire)),
            sheet.ColdResistanceBasisPoints,
            P30CombatRules.EffectiveResistance(sheet.ColdResistanceBasisPoints, sheet.ResistanceMaximum(EnemyDamageType.Cold)),
            sheet.LightningResistanceBasisPoints,
            P30CombatRules.EffectiveResistance(sheet.LightningResistanceBasisPoints, sheet.ResistanceMaximum(EnemyDamageType.Lightning)),
