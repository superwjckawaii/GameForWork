...
public sealed record SkillConfiguration(
    ...
    IReadOnlyList<SupportMechanic>? ArchetypeSupports = null, int Quality = 0,
    IReadOnlyList<string>? SupportIds = null,
    IReadOnlyList<LinkedSupport>? SupportLinks = null, string Mode = "")
{
    public IReadOnlyList<SupportMechanic> ExtendedSupports => ArchetypeSupports ?? Array.Empty<SupportMechanic>();
    public IReadOnlyList<string> ExtendedBuildsSupports => SupportIds ?? Array.Empty<string>();
    public IReadOnlyList<LinkedSupport> ExtendedBuildsSupportLinks => SupportLinks ?? Array.Empty<LinkedSupport>();
}
...
{
    private static readonly IReadOnlyDictionary<string, SkillDefinition> Catalog = ActiveSkillCatalog.Active
    ...
    public static SkillDefinition HeavyStrike => Get(SkillIds.HeavyStrike);
    public static SkillDefinition WarCry => Get(SkillIds.WarCry);
    public static SkillDefinition EarthCleave => Get(SkillIds.EarthCleave);
    public static SkillDefinition SpiritBlade => Get(SkillIds.SpiritBlade);
    public static SkillDefinition SeismicCharge => Get(SkillIds.SeismicCharge);
    public static SkillDefinition BloodTideSpin => Get(SkillIds.BloodTideSpin);
    public static SkillDefinition IronOathBanner => Get(SkillIds.IronOathBanner);
    public static SkillDefinition AshJavelin => Get(SkillIds.AshJavelin);
    public static SkillDefinition EmberNova => Get(SkillIds.EmberNova);
    public static SkillDefinition StormBrand => Get(SkillIds.StormBrand);
...
public static class SkillRules
{
    ...
    {
        if (configuration.SkillId != SkillIds.HeavyStrike)
        {
    ...
    public static SkillUseProfile BuildWarCry() => new(
        SkillIds.WarCry,
        ManaCost: SkillDefinitions.WarCry.BaseManaCost,
        LifeCost: 0,
        RangeRaw: SkillDefinitions.WarCry.RangeRaw,
        AttackIntervalTicks: 0,
        UncappedAttackFrequencyMilliPerSecond: 0,
        CastTimeTicks: SkillDefinitions.WarCry.CastTimeTicks,
        CooldownTicks: SkillDefinitions.WarCry.CooldownTicks,
