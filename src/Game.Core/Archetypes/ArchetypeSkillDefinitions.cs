...
public static class ArchetypeSkillDefinitions
{
    ...
    [
        ...
        A(BaseClass.Rogue, "venom_blades", "淬毒飞刃", SkillMechanic.Poison, SkillTag.Attack | SkillTag.Projectile | SkillTag.Physical | SkillTag.Void,
            AttackHit | SkillCapability.Projectile | SkillCapability.PhysicalDamage | SkillCapability.VoidDamage | SkillCapability.Duration, SkillRole.Clear, SkillDamageType.Void, SkillShape.Projectile, 11, 8_500, 2, 14, 9_500, "物理伤害全部转为虚空，击中有60%中毒概率。", Ailment.Poison, 6_000),
        A(BaseClass.Rogue, "corrosive_trap", "腐蚀陷阱", SkillMechanic.Trap, SkillTag.Attack | SkillTag.Area | SkillTag.Duration | SkillTag.Physical | SkillTag.Void,
            AttackHit | SkillCapability.Area | SkillCapability.Duration | SkillCapability.Triggerable | SkillCapability.PhysicalDamage | SkillCapability.VoidDamage, SkillRole.DamageOverTime, SkillDamageType.Void, SkillShape.GroundArea, 14, 7_000, 3, 28, 8_500, "布置持续八秒、敌人进入两米时触发的腐蚀陷阱。", Ailment.Erosion, 8_000),
