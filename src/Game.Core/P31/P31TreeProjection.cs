...
public readonly record struct P31ProjectedPoint(float X, float Y);

public readonly record struct P31ProjectedSquare(float X, float Y, float Side);
...
/// </summary>
public static class P31TreeProjection
{
    ...
    public static P31ProjectedPoint WorldToScreen(float worldX, float worldY,
    ...
    public static P31ProjectedPoint ScreenToWorld(float screenX, float screenY,
        float centerX, float centerY, float zoom)
    {
        RequireZoom(zoom);
    ...
    public static P31ProjectedSquare BackdropSquare(float centerX, float centerY,
    ...
    public static P31ProjectedPoint SourcePixelToScreen(float pixelX, float pixelY, int sourceSize,
        float centerX, float centerY, float extent, float zoom)
    {
        RequireSourceSize(sourceSize);
        P31ProjectedSquare square = BackdropSquare(centerX, centerY, extent, zoom);
