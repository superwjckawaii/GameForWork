...
$destinationDirectory = Join-Path $RepositoryRoot 'src\Game.Godot\art-source\monsters\imagegen'
$destination = Join-Path $destinationDirectory 'monsters-monster-family-master.png'
...
Write-Host "Monsters monster family source prepared at $destination"
