#!/usr/bin/env python3
"""Build the deterministic EquipmentImport equipment snapshot from PoB Community Lua data."""
...
IMPORTED_DISPLAY_NAMES = {
    "equipmentImport.base.headman_s_sword": "断首巨剑", "equipmentImport.base.ezomyte_blade": "艾兹麦巨刃",
    "equipmentImport.base.imperial_maul": "帝王重槌", "equipmentImport.base.void_axe": "虚界巨斧",
    "equipmentImport.base.broad_sword": "阔刃剑", "equipmentImport.base.ceremonial_mace": "仪典战锤",
    "equipmentImport.base.cutlass": "斩浪弯刀", "equipmentImport.base.flanged_mace": "破血钉锤",
    "equipmentImport.base.karui_axe": "裂岭战斧", "equipmentImport.base.butcher_axe": "屠骨斧",
    "equipmentImport.base.harpy_rapier": "鹰身细剑", "equipmentImport.base.linden_kite_shield": "椴木鸢盾",
    "equipmentImport.base.jingling_spirit_shield": "铃鸣灵盾", "equipmentImport.base.maple_round_shield": "枫木圆盾",
    "equipmentImport.base.crimson_round_shield": "赤红圆盾", "equipmentImport.base.ironwood_buckler": "铁木小盾",
    "equipmentImport.base.ezomyte_tower_shield": "艾兹麦塔盾", "equipmentImport.base.supreme_spiked_shield": "至尊刺盾",
    "equipmentImport.base.elegant_ringmail": "雅致环甲", "equipmentImport.base.carnal_armour": "血肉战甲",
    "equipmentImport.base.sinner_tricorne": "罪人三角帽", "equipmentImport.base.bone_helmet": "骸骨战盔",
    "equipmentImport.base.trapper_mitts": "捕兽手套", "equipmentImport.base.samite_gloves": "丝纹手套",
    "equipmentImport.base.stealth_gloves": "潜行手套", "equipmentImport.base.spiked_gloves": "刺钉拳套",
    "equipmentImport.base.riveted_boots": "铆钉战靴", "equipmentImport.base.ambush_boots": "伏击短靴",
    "equipmentImport.base.vaal_greaves": "瓦尔胫甲", "equipmentImport.base.two_toned_boots_evasion_energy_shield": "霜雷双色靴",
    "equipmentImport.base.studded_belt": "钉饰腰带", "equipmentImport.base.mechanical_belt": "机械腰带",
    "equipmentImport.base.crystal_belt": "水晶腰带", "equipmentImport.base.hexclaw_talisman": "六爪护符",
    "equipmentImport.base.rhex_talisman": "犀角护符", "equipmentImport.base.tiger_talisman": "虎牙护符",
    "equipmentImport.base.blue_pearl_amulet": "蓝珍珠护符", "equipmentImport.base.vermillion_ring": "朱砂戒指",
}
    ...
    for category, (slot, count, names) in TARGETS.items():
        ...
        for index, item in enumerate(selected):
            ...
            if index < len(legacy):
                ...
                item["stableId"] = f"equipmentImport.base.{slug}"
                try:
...
def load_affixes(root: Path, base_tags: set[str]) -> tuple[list[dict], list[Path]]:
    ...
    for path in source_paths:
        ...
        for line in path.read_text(encoding="utf-8").splitlines():
            ...
            records.append({
                "stableFamilyId": f"equipmentImport.affix.{stable_group}", "sourceId": source_id,
