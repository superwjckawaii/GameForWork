...
function Build-SkillAtlas {
    ...
    $graphics.Dispose();$atlas.Save((Join-Path $uiRoot 'art-skill-gems.png'),[System.Drawing.Imaging.ImageFormat]::Png);$atlas.Dispose()
}
...
function Build-UiSkin {
    ...
    $graphics.Dispose();$atlas.Save((Join-Path $uiRoot 'art-ui-skin.png'),[System.Drawing.Imaging.ImageFormat]::Png);$atlas.Dispose()
}
...
function Build-Brand {
    ...
    $graphics.Dispose();$icon.Save((Join-Path $brandRoot 'art-app-icon.png'),[System.Drawing.Imaging.ImageFormat]::Png);Save-PngIco $icon (Join-Path $brandRoot 'art-app-icon.ico')
    $states=@{normal='#4d9fd1';waiting='#d8af48';paused='#777d88';error='#d45c57'}
    foreach($entry in $states.GetEnumerator()){$tray=New-Bitmap 32 32;$g=New-Graphics $tray;$g.DrawImage($icon,[System.Drawing.Rectangle]::new(1,1,30,30));$brush=[System.Drawing.SolidBrush]::new((Get-Color $entry.Value));$g.FillRectangle([System.Drawing.Brushes]::Black,22,22,9,9);$g.FillRectangle($brush,24,24,5,5);$brush.Dispose();$g.Dispose();$tray.Save((Join-Path $brandRoot "art-tray-$($entry.Key).png"),[System.Drawing.Imaging.ImageFormat]::Png);$tray.Dispose()}
...
Build-UiSkin
Build-Brand
Write-Host '[art.1-assets] Generated deterministic icons, UI skin and application branding.'
