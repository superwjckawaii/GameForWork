...
项目已完成 P0～P31 的 `v0.4.0` 候选实现。玩家可以完成五幕主线和七座固定城区建设，进入 T1～T20 异界，体验裂渊、命能花园、赤誓/苍誓祭坛、亡旗战阵、百级突破与固定 Boss 攻坚；构筑系统包含 86 个主动技能、98 个辅助技能、正式装备与词缀库、1475 节点主天赋树、十八升华、珠宝、美德/恶德与 360 节点异界树。任务栏小窗、数据驱动技能表现、装备覆盖层、分色伤害数字和低密度精细像素素材均已接入。
