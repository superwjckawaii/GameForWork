...
项目已完成 P0～P21.1。玩家可以完成五幕主线和七座固定城区建设，进入 T1～T20 异界，体验裂渊、命能花园、赤誓/苍誓祭坛、百级突破与三阶段灰烬天垒攻坚；构筑系统包含正式装备与词缀库、主动/辅助技能、五类药剂、1200 节点主天赋树和 360 节点异界树，并已接入适合任务栏小窗的正式低密度像素图标、四方向动作、战斗特效、三类天赋背景、统一像素 UI 与正式应用图标。
