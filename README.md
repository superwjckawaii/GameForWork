...
项目已完成 P0～P22 的 `v0.2.0` 候选实现。玩家可以完成五幕主线和七座固定城区建设，进入 T1～T20 异界，体验裂渊、命能花园、赤誓/苍誓祭坛、百级突破与三阶段灰烬天垒攻坚；构筑系统包含正式装备与词缀库、主动/辅助技能、五类药剂、1200 节点主天赋树和 360 节点异界树，并已接入适合任务栏小窗的正式低密度像素图标、四方向动作、战斗特效、由实际节点数据生成的三类天赋背景、统一像素 UI、分级底材效果与正式应用图标。

## 本地运行与验证

当前已完成 v0.4 P29：五玩法真实节点、族群/稀有度掉落池、36 件常规传奇、玩法资源直接做装、18 种战功底材、地图续航保底与固定种子经济审计。规格见 [P29](docs/v0.4/P29_SPECIFICATION.md)；下一阶段 P30 负责构筑数值再平衡。
