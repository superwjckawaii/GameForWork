...
项目已完成 Foundation～Presentation 的 `v0.4.0` 候选实现。玩家可以完成五幕主线和七座固定城区建设，进入 T1～T20 异界，体验裂渊、命能花园、赤誓/苍誓祭坛、亡旗战阵、百级突破与固定 Boss 攻坚；构筑系统包含 86 个主动技能、98 个辅助技能、正式装备与词缀库、1475 节点主天赋树、十八升华、珠宝、美德/恶德与 360 节点异界树。任务栏小窗、数据驱动技能表现、分色伤害数字和低密度精细像素素材均已接入。

## 本地运行与验证

当前正在规划 v0.5：唯一新增大型玩法为沉金港，同时审核、优化全部现有动画效果。沉金港消耗金币，主要产出特殊巅峰底材与专属传奇，成功带出后获得宝箱，开启时选择奖励；普通刷图宝箱开启后全部领取。无光矿脉延期，具体版本待定。开发顺序见 [v0.5 六阶段计划](docs/v0.5/V0_5_DEVELOPMENT_PLAN.md)，第一阶段方案已统一确认，第一阶段规格、静态审计与代表场景性能前测已交付；前测发现的问题交由第四/第五阶段修复验收。
...
- [Foundation～Release 开发计划与协作流程](docs/shared/DEVELOPMENT_PLAN.md)
- [v0.1 Demo 路线与历史规格](docs/v0.1/DEMO_ROADMAP.md)
- [v0.2 核心战斗与构筑扩充规格](docs/v0.2/V0_2_SPECIFICATION.md)
- [Inventory 怪物、等级、仓库与过滤器规格](docs/v0.2/Inventory_SPECIFICATION.md)
- [Art 像素美术、逐帧动画与稳定图集规格](docs/v0.2/Art_SPECIFICATION.md)
- [Release 整合、平衡与 v0.2 封版规格](docs/v0.2/Release_SPECIFICATION.md)
- [v0.2.0 版本说明](docs/v0.2/V0_2_RELEASE_NOTES.md)
- [v0.4 总规格](docs/v0.4/V0_4_SPECIFICATION.md)
- [Presentation 表现、性能与发布封版规格](docs/v0.4/Presentation_SPECIFICATION.md)
